...
class MazeEnvironment:
    ...
    """
    def __init__(self, agent, walls, exit_point, exit_range=10.0):
        """
    ...
    def update_radars(self):
        ...
        """
        target = Point(self.exit_point.x, self.exit_point.y)
    ...
    def update(self, control_signals):
        ...
        vx = math.cos(deg_to_rad(self.agent.heading)) * self.agent.speed
        vy = math.sin(deg_to_rad(self.agent.heading)) * self.agent.speed
